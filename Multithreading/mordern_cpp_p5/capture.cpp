...
int main()
{
    ...
    // Lambda expression which capture "strings" by reference
    [&strings](){
    ...
    // Lambda expression which capture "strings" by move
    //Crete a new variable "vec_strings" which is local to the lambda body
